...
class LabelDetector:
    def __init__(self, paper_cfg: dict, ocr_cfg: dict):
        self.paper_cfg = paper_cfg or {}
        self.ocr_cfg = ocr_cfg or {}

        self.mask_path = resolve_path(self.paper_cfg.get("mask_path") or "Mask.png")
        ...
        self.ocr_image_processor, self.ocr_tokenizer, self.ocr_model = self._load_ocr_model(self.ocr_model_id)
