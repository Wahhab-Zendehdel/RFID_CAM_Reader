...
# Reduce OpenCV/ffmpeg verbose logs early (must be set before importing cv2)
import os
...
class CameraReader:
    def __init__(
        ...
        # Try to reduce verbose ffmpeg/OpenCV logs that appear on stderr.
        # Use OpenCV API when available; ignore failures.
        try:
            # OpenCV >=4.5
